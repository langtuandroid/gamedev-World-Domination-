Shader "ExactColorShader/ToonTexture"
{
    Properties
    {
        ...
        _RimAmount("Rim Amount", Float) = 250
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                {
                    result = mainTexColor * baseColorPlusShadow;
                }
                ...
                else if (_TextureBlendMode == 2)
                {
                    ...
                    result = lerp(shadowColorResult, result, shadowAmount);
                }
